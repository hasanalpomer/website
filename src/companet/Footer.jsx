...
const Footer = () => {
  return (
    <>
      <footer className=" relative mt-5 border-t w-full h-auto   bg-white flex justify-center items-center   py-4">
        <div className="container">
          <div className="flex">
            ...
            <div className="w-full  px-2 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base text-body-color">
                  ...
                  © {new Date().getFullYear()} Mert Baybagan
                </p>
              </div>
            </div>
          </div>
